...
public final class FragmentForgotPassBinding implements ViewBinding {
  ...
  private FragmentForgotPassBinding(@NonNull LinearLayout rootView,
      @NonNull TextInputEditText edtEmailForgot, @NonNull TextView txtErrEmail) {
    this.rootView = rootView;
    this.edtEmailForgot = edtEmailForgot;
  ...
  public static FragmentForgotPassBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_forgot_pass, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentForgotPassBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.edtEmailForgot;
      TextInputEditText edtEmailForgot = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentForgotPassBinding((LinearLayout) rootView, edtEmailForgot, txtErrEmail);
    }
