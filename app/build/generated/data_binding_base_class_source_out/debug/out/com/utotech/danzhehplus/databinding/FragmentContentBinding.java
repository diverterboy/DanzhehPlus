...
public final class FragmentContentBinding implements ViewBinding {
  ...
  private FragmentContentBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView recyclerContents) {
  ...
  public static FragmentContentBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recyclerContents;
      RecyclerView recyclerContents = ViewBindings.findChildViewById(rootView, id);
      if (recyclerContents == null) {
        break missingId;
      }

      return new FragmentContentBinding((FrameLayout) rootView, recyclerContents);
    }
